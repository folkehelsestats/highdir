...
#'   defaults to "Kilde: Navn av kilder". Default is NULL.
...
#' @param filename Character string. Base filename for exported charts (without extension).
