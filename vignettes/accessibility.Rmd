...
alternative text.
It is **invisible to sighted users** — it does not appear on the figure —
...
Setting `description` enhances all of these — it gives the user orientation
...
Avoid repeating the title verbatim — the screen reader will have already
announced the title.
