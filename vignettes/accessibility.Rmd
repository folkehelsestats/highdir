...
gg_fig <- hd_make(spec_line, "line", opts_gg, mode = "static")
...
hd_make(spec_line, "line", opts_gg, mode = "static")
```
````
...
hd_make(spec_line, "line", opts_good, mode = "static")
```
...
hd_make(spec_line2, "line", opts_grouped, mode = "static")
```
