...
hd_make(spec_col, "column", opts_flip, backend = "static")
```
...
hd_make(spec_line1, "line", opts_line, smooth = FALSE, backend = "static")
```
...
# Spline (smooth) — default
hd_make(spec_line1, "line", opts_line, backend = "static")
```
...
hd_make(spec_rb, "ranked_bar", opts_rb, backend = "static")
```
...
hd_make(spec_rb, "ranked_bar", opts_rb, ascending = FALSE, backend = "static")
```
...
hd_make(spec_rb, "ranked_bar", opts_rb, aim = 60, backend = "static")
```
...
hd_make(spec_rb, "ranked_bar", opts_rb, vs = "Oslo", backend = "static")
...
hd_make(spec_rb_no_n, "ranked_bar", opts_rb, backend = "static")
...
hd_make(spec_ar2, "arearange", opts_ar,
        ymin = "lower_95CI", ymax = "upper_95CI", backend = "static")
```
...
```{r gg-pie}
# Donut static
hd_make(spec_pie, "pie", opts_pie, inner_size = "50%", backend = "static")
```
...
hd_make(spec_pie, "pie", opts_pie, backend = "static")
```
...
hd_make(spec_ts, "line", opts_en)
hd_make(spec_ts, "line", opts_en, backend = "static")
...
gg_fig <- hd_make(spec_ts, "line", opts_en, backend = "static")
