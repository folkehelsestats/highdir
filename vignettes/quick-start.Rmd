...
> [!NOTE]
> Use argument `backend` instead of `mode` if you are using version 0.5.0
> Read [Changelog](https://folkehelsestats.github.io/highdir/news/index.html "changelog") for more information
