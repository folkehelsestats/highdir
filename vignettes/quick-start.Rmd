...
> [!NOTE]
>
> `backend` will be replaced by `mode` in a future release.
> New code should prefer `mode`, while users of **highdir 0.5.0** should continue to use `backend`.
>
> See the [changelog](https://folkehelsestats.github.io/highdir/news/index.html) for more information.
