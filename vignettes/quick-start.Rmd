...
- `hd_opts()` - for presentation specification or options that can be applicable to multiple geoms
- `required specification` - the arguments that must be specified based on geom type
- `optional specification` - other optional specification depending on the selected geom types
