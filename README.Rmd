...
A figure is described once as a `fig_spec` object and rendered to either backend
without changing the calling code. The package ships with the default to use
Helsedirektoratet colour palette, styling and theme. A Shiny GUI is introduce to
