...
**highdir** is an R package that provides a unified, mode-agnostic API for
building dynamic or static figures with either [**highcharter**](https://jkunst.com/highcharter/),
[**ggplot2**](https://ggplot2.tidyverse.org/) or other R solutions where relevant.
...
can later be rendered to different modes. Mode-specific presentation
...
To further enhance usability, a Shiny graphical user interface for building and previewing figures is also included as part of the package.
...
The app is also available directly through ShinyApps.io at: [https://ybkamaleri.shinyapps.io/highdir/](https://ybkamaleri.shinyapps.io/highdir/ "highdir") 
