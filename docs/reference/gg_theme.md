...
#> Error in gg_theme("classic", colors = c("#025169", "#7C145C")): unused argument (colors = c("#025169", "#7C145C"))
gg_theme("minimal", font = "Source Sans Pro")
#> Error in gg_theme("minimal", font = "Source Sans Pro"): unused argument (font = "Source Sans Pro")
gg_theme(ggplot2::theme_bw(base_size = 14), font = "mono")
#> Error in gg_theme(ggplot2::theme_bw(base_size = 14), font = "mono"): unused argument (font = "mono")
```
